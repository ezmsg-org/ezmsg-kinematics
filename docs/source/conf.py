...
try:
    from ezmsg.kinematics.__version__ import version as release
except ImportError:
    release = "unknown"
...
html_baseurl = "https://www.ezmsg.org/ezmsg-kinematics/"

html_theme_options = {
    "logo": {
        "text": f"ezmsg.kinematics {version}",
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/ezmsg-org/ezmsg-kinematics",
...
branch = "main"
code_url = f"https://github.com/ezmsg-org/ezmsg-kinematics/blob/{branch}/"
